    ...
    return (
        <>
            <div className='relative'>
                ...
                {selectedPages.length === 0 && <span className='fixed top-[55px] right-4  z-50  text-red-500 bg-white p-1 shadow-lg rounded'>select at least one page to extract</span>}
